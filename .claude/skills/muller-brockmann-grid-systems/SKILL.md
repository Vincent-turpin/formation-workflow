...
- **Real photography.** Ground real subjects in real photos. Host each image publicly and embed its public URL — a sandboxed iframe artifact can't authenticate thread-scoped file URLs (broken-image trap).
